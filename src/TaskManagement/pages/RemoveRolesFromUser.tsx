...
import { getUserById, removeRolesFromUser } from "../services";
...
const RemoveRolesFromUserPage = () => {
  ...
  const handleRemoveRoles = async () => {
    ...
    setSubmitting(true);
    try {
      await removeRolesFromUser(Number(userId), selectedRoleIDs);
      setSuccess(true);
      setSelectedRoleIDs([]);
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-red-100 mt-1">
                    Revoke user roles and reduce permissions
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="space-y-6">
              ...
              {!userData.roles || userData.roles.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                  <ShieldExclamationIcon className="w-16 h-16 mx-auto text-gray-300 mb-4" />
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">
                    No roles to remove
                  </h3>
                  <p className="text-gray-500">
                    This user doesn't have any roles assigned.
                  </p>
                </div>
              ) : (
                <>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700">
                          Removing roles will immediately revoke the user's
                          permissions associated with those roles. Please
                          confirm your selection carefully.
                        </p>
                      </div>
                    </div>
                  </div>
...
export default RemoveRolesFromUserPage;
