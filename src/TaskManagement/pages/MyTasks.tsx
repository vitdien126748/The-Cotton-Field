            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                {filteredTasks?.map((task, index) => (
                  <tr
                    key={task.id}
                    className={`hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group animate-fade-in ${
                  ...
                  >
                    ...
                    <td className="px-4 py-4 font-medium text-gray-900 group-hover:text-green-600 transition-colors">
                      {task.title}
                    </td>
